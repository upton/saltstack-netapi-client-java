...
public class JsonParser<T> {
    ...
    public static final JsonParser<Result<List<Map<String, Map<String, String>>>>> RETVALS_ALL =
            new JsonParser<>(new TypeToken<Result<List<Map<String, Map<String, String>>>>>(){});
